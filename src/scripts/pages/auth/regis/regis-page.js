import regisConfig from "./regis-config.js";
import * as StoriesAPI from "../../../data/api.js"

export default class regisPage{
    #presenter = null;
    ...
    async afterRender(){
        this.#presenter = new regisConfig({
            view: this,
            model: StoriesAPI,
        });
        this.#setupForm();
    ...
    #setupForm(){
        document.getElementById('register-form').addEventListener('submit', async (e) => {
            ...
            await this.#presenter.getRegis(data);
        });
    }

    regisSuccess(message){
        console.log(message);
        location.hash = '/login';
    }
    ...
    showSubmitLoadingbtn(){
        document.getElementById('submit-button-container').innerHTML = `
            <button class="btn" type="submit" disabled>
                <i class="fa fa-spinner loader-button"></i> Daftar akun</button>
        `;
    }
